package com.maxart.payment_hyper;
import android.content.ComponentName;
import android.content.Context;
import android.content.Intent;

import com.maxart.payment_hyper.CheckoutBroadcastReceiver;
...
public class MainActivity extends FlutterActivity implements ITransactionListener,MethodChannel.Result {
    ...
    private void openCheckoutUI(String checkoutId) {
        ...
        CheckoutSettings checkoutSettings =  new CheckoutSettings(checkoutId,paymentBrands,
                Connect.ProviderMode.TEST).setShopperResultUrl("com.maxart.payment_hyper://result");

        if (mode.equals("LIVE")) {
            checkoutSettings =  new CheckoutSettings(checkoutId,paymentBrands,
                    Connect.ProviderMode.LIVE).setShopperResultUrl("com.maxart.payment_hyper://result");
        }
    ...
    private void openCustomUI(String checkoutid) {
        ...
        if (STCPAY.equals("enabled")) {
            ...
            try {
                ...
                paymentParams.setShopperResultUrl("com.maxart.payment_hyper://result");
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (intent.getScheme().equals("com.maxart.payment_hyper")) {
